...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/pet?action=list" method="get">
        <input type="text" name="keyword" placeholder="검색어 입력">
        <button type="submit">검색</button>
    </form>

    <button type="button" onclick="location.href='${pageContext.request.contextPath}/pet/petInput.jsp'">펫 추가</button>
